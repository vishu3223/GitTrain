...
"undefined"==typeof usi_company&&(window.usi_company={rulesets:{testing:function(e){return void 0===e.testing||(e.testing?usi_cookies.get("usi_enable"):e.testing?void 0:!usi_cookies.get("usi_enable"))},device:function(e){return!e.device||usi_commons.device===e.device},required_cookies:function(e){return!e.required_cookies||usi_cookies.value_exists.apply(null,e.required_cookies)},suppress_cookies:function(e){if(!e.suppress_cookies)return!0;for(var r=0;r<e.suppress_cookies.length;r++)if(usi_cookies.value_exists(e.suppress_cookies[r]))return!1;return!0},required_elements:function(e){if(!e.required_elements)return!0;try{for(var r=0;r<e.required_elements.length;r++)if(!document.querySelector(e.required_elements[r]))return!1;return!0}catch(t){return!1}},min_subtotal:function(e){var r=usi_cookies.get("usi_subtotal")?Number(usi_cookies.get("usi_subtotal").replace(/[^0-9.]/g,"")):0;return!e.min_subtotal||r>e.min_subtotal},max_subtotal:function(e){var r=usi_cookies.get("usi_subtotal")?Number(usi_cookies.get("usi_subtotal").replace(/[^0-9.]/g,"")):0;return!e.max_subtotal||r<e.max_subtotal},date_ranges:function(e){return e.date_ranges&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.date_ranges||e.date_ranges.some(function(e){return usi_date.is_between(e[0],e[1])})},is_after:function(e){return e.is_after&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.is_after||usi_date.is_after(e.is_after)},is_before:function(e){return e.is_before&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.is_before||usi_date.is_before(e.is_before)},page_visits:function(e){return!e.page_visits||Number(usi_cookies.get("usi_page_visits"))>=e.page_visits},countries:function(e){return e.countries&&!usi_app.country?usi_commons.log("usi_app.country is required"):!e.countries||-1!==e.countries.indexOf(usi_app.country)},traffic_source:function(e){return void 0===e.traffic_source||(usi_cookies.get("usi_traffic_source")||usi_commons.log_error("usi_traffic_source required"),""===usi_cookies.get("usi_traffic_source")&&-1!==e.traffic_source.indexOf("direct")||e.traffic_source.some(function(e){return -1!==usi_cookies.get("usi_traffic_source").indexOf(e)}))},pages:function(e){return void 0===e.pages||e.pages.some(function(e){return -1!==location.href.indexOf(e)})},suppressed_pages:function(e){return void 0===e.suppressed_pages||!e.suppressed_pages.some(function(e){return -1!==location.href.indexOf(e)})},logged_in:function(e){return void 0===e.logged_in||(e.logged_in?"loggedin"===usi_cookies.get("usi_visitor"):e.logged_in?void 0:"loggedin"!==usi_cookies.get("usi_visitor"))},logged_out:function(e){return void 0===e.logged_out||(e.logged_out?"loggedin"!==usi_cookies.get("usi_visitor"):e.logged_out?void 0:"loggedin"===usi_cookies.get("usi_visitor"))},return_visitor:function(e){return void 0===e.return_visitor||((void 0===usi_app.is_return_visitor&&usi_commons.log_error("usi_app.is_return_visitor is required"),e.return_visitor)?usi_app.is_return_visitor:e.return_visitor?void 0:!usi_app.is_return_visitor)},new_visitor:function(e){return void 0===e.new_visitor||((void 0===usi_app.is_return_visitor&&usi_commons.log_error("usi_app.is_return_visitor is required"),e.new_visitor)?!usi_app.is_return_visitor:e.new_visitor?void 0:usi_app.is_return_visitor)},return_customer:function(e){return void 0===e.return_customer||(e.return_customer?usi_cookies.get("usi_customer_purchased"):e.return_customer?void 0:!usi_cookies.get("usi_customer_purchased"))},new_customer:function(e){return void 0===e.new_customer||(e.new_customer?!usi_cookies.get("usi_customer_purchased"):e.new_customer?void 0:usi_cookies.get("usi_customer_purchased"))}},test_load:function(e,r){return!1},before_load:function(e){usi_commons.log("Loading: "+(e._name?e._name+", ":e.name?e.name+", ":"")+(e.siteID?e.siteID+", ":"")+(e.key?e.key:"")),"string"==typeof e.before_load&&"function"==typeof usi_app[e.before_load]&&usi_app[e.before_load](e)},load_campaigns:function(e,r){try{if(!e||!e.campaigns)return;function t(e,r){var t=0;!function i(){if(!(t>=e.length)){var s=e[t++];r(s,function(e){e||i()})}}()}function i(e,r,t){if(!e)return"";var i=e.match(/^{{\s*usi_app\.([\w.]+)\s*}}$/);if(i){var s=i[1].split(".");let o=usi_app;for(let n of s){if(null==o||"object"!=typeof o)return e;o=o[n]}return"function"==typeof o?o(t||r):o}return e.replace(/{{\s*usi_commons\.device\s*}}/,usi_commons.device).replace(/{{\s*usi_app\.([\w.]+)\s*}}/g,function(e,r){if(!r)return e;for(var i=r.split("."),s=usi_app,o=0;o<i.length;o++){if(null==s||"object"!=typeof s)return e;s=s[i[o]]}return null==s?e:"function"==typeof s?s(t):s})}function s(e,r){var t=Object.assign({},e);for(var s in t)t.hasOwnProperty(s)&&"string"==typeof t[s]&&t[s].match(/{{\s*usi_app\.(\w+)\s*}}/)&&(t[s]=i(t[s],t,r));return t}function o(e,r){try{var t,o,n,u=[],a={};if(e.segments&&Array.isArray(e.segments))for(var c=0;c<e.segments.length;c++){var f=e.segments[c],p=[];for(var l in f)if(f.hasOwnProperty(l)){var d=usi_company.custom_rulesets[l]||usi_company.rulesets[l];"function"!=typeof d||d(Object.assign({},e,f))||p.push(l)}if(0===p.length){a=f;break}}var g=Object.assign({},e,a);for(var c in"view"===g._type&&"undefined"==typeof usi_force&&-1==location.href.indexOf("usi_force")&&(g.suppress_cookies=g.suppress_cookies||[],-1===g.suppress_cookies.indexOf("usi_sale")&&g.suppress_cookies.push("usi_sale","usi_launched","usi_launched"+g.siteID),e.suppress_cookies=g.suppress_cookies),g.siteID||u.push("siteID"),"anon"==g._type||g.hash||u.push("hash"),usi_company.rulesets)!usi_company.custom_rulesets[c]&&usi_company.rulesets.hasOwnProperty(c)&&((0,usi_company.rulesets[c])(g)||u.push(c));for(var v in usi_company.custom_rulesets)usi_company.custom_rulesets.hasOwnProperty(v)&&((0,usi_company.custom_rulesets[v])(g)||u.push(v));if(e._missing=u,u.length>0)return r(!1);var m=[];if(g.list){if(!usi_app.company_id)return usi_commons.log_error("usi_app.company_id is required");if(!g.list.ids)return usi_commons.log_error("campaign.list.ids is required");if(!g.list.label)return usi_commons.log_error("campaign.list.label is required");m.push(function(r){var t=s(g.list,g);if(g.product=Array.isArray(t.ids)?t.ids.join(","):i(t.ids,g),g.save_token="usi_ls_"+g.list.label+"_"+g.product,sessionStorage[g.save_token])return r("true"===sessionStorage[g.save_token]);usi_company.lookup_callback=function(i){try{e.list._found=i,t.type=t.type||"suppress";var s=0===i&&"suppress"===t.type||1===i&&"enable"===t.type;sessionStorage.setItem(g.save_token,s.toString()),r(s)}catch(o){usi_commons.report_error(o)}};var o=usi_commons.domain+"/utility/lookup_suppressions.jsp?companyID="+usi_app.company_id+"&product="+g.product+"&label="+t.label+"&match="+(t.match||"any")+"&callback=usi_company.lookup_callback";usi_commons.load_script(o)})}if(g.lift){if("undefined"==typeof usi_split_test)return usi_commons.log_error("usi_split_test is required");if(!g.lift.id)return usi_commons.log_error("campaign.lift.id is required");m.push(function(r){usi_split_test.instantiate_callback(g.lift.id,function(t){if(0===t)return r(!1);e.lift._group=t,r(!0)})})}"object"==typeof g.split&&m.push(function(r){var t,i=Object.keys(g.split),s=usi_commons.gup("usi_force_group");if(s)t=s;else if(g._group)t=g._group;else if(g.lift&&"boolean"==typeof g.lift.split&&g.lift.split&&g.lift._group)t=g.lift._group;else{for(var o=0,n={},u=0;u<i.length;u++){var a=i[u],c=g.split[a].percent;n[a]="number"==typeof c&&c>0?c:1,o+=n[a]}for(var f=Math.random()*o,p=0,l=0;l<i.length;l++){var d=i[l];if(p+=n[d],f<p){t=d;break}}t||(t=i[0])}var v=g.split[t];for(var m in v)v.hasOwnProperty(m)&&(g[m]=v[m]);e._group=t,r(!0)}),g.recommendations&&m.push(function(e){var r=s(g.recommendations,g);return r.pid?r.siteID?void(r.callback=function(){var r=g.recommendations.name?g.recommendations.name.replace("usi_app.",""):"product_rec",t=usi_commons.gup("usi_test")||(usi_app[r]&&usi_app[r].data&&usi_app[r].data.length?usi_app[r].data.length:0)>=(g.recommendations.min_rows||g.recommendations.rows||3);g.recommendations.filter_callback&&"function"==typeof usi_app[g.recommendations.filter_callback]&&usi_app[g.recommendations.filter_callback](g),e(t)},usi_commons.load_products(r)):usi_commons.log_error("recommendations.siteID is required"):usi_commons.log_error("recommendations.pid is required")}),t=m,o=function(e){r(e,g)},n=0,function e(r){return r?n>=t.length?o(!0):void t[n++](e):o(!1)}(!0)}catch(y){usi_commons.report_error(y),r(!1)}}usi_company.custom_rulesets=r||[],e.campaigns.usi_load&&t(e.campaigns.usi_load,function(e,r){e._type="usi_load",o(e,function(t,o){e._active=t,t&&o&&o.siteID&&o.hash?(usi_company.before_load(o),usi_commons.load(o.hash,o.siteID,o.key?i(o.key,o):"",function(){void 0!==window["usi_"+o.siteID]&&(window["usi_"+o.siteID].company_json=s(o)),r(usi_company.test_load(t,o))})):r(t)})}),e.campaigns.view&&t(e.campaigns.view,function(e,r){e._type="view",o(e,function(t,o){e._active=t,t&&o&&o.siteID&&o.hash&&(usi_company.before_load(o),usi_commons.load_view(o.hash,o.siteID,o.key?i(o.key,o):"",function(){"undefined"!=typeof usi_js&&(usi_js.company_json=s(o))})),r(t)})}),e.campaigns.anon&&t(e.campaigns.anon,function(e,r){e._type="anon",o(e,function(t,i){e._active=t,i&&i.siteID&&(usi_app.anon_data=s(i),t&&(usi_company.before_load(i),usi_user_id.activate(i.siteID))),r(t)})}),e.campaigns.precapture&&t(e.campaigns.precapture,function(e,r){e._type="precapture",o(e,function(t,i){e._active=t,i&&i.siteID&&i.hash&&(usi_app.precapture_data=s(i),t&&(usi_company.before_load(i),usi_commons.load_precapture(i.hash,i.siteID))),r(t)})})}catch(n){usi_commons.report_error(n)}}});
			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					if (usi_app.is_enabled && usi_cookies.value_exists('stck_unlimited')) {
						...
						} else if (usi_app.is_checkout_page && document.querySelectorAll('main').length > 0 && document.querySelectorAll('main')[0].textContent.toLowerCase().indexOf('unlimited downloads') == -1) {
							unlimited_eligible = true;
						...
						if (unlimited_eligible) {
							...
							if((usi_app.is_cart_page) || (usi_app.is_checkout_page && usi_cookies.value_exists('usi_prod_name_1'))) {
								...
								load_campaign({"site_id": 59637,"site_key": "IAFjlzjGPPyKyvM7zKLHWSX", "split_test_id": 59641});
							}
